...
export function EditLoanDialog({ loan, open, onOpenChange }: EditLoanDialogProps) {
  ...
  const onSubmit = (values: EditLoanFormData) => {
    setIsSubmitting(true);
    const loanDocRef = doc(firestore, 'loans', loan.id);
    
    // NOTE: Editing principal/interest might require recalculating installments.
    // For now, this is a simple update. A full implementation would be more complex.
    const updates = {
